...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { description: @controller.description, dob: @controller.dob, sl_no: @controller.sl_no, text: @controller.text }
    end
  ...
  test "should update controller" do
    patch :update, id: @controller, controller: { description: @controller.description, dob: @controller.dob, sl_no: @controller.sl_no, text: @controller.text }
    assert_redirected_to controller_path(assigns(:controller))
  end
